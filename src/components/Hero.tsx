...
const slides = [
  {
    ...
    image: "https://images.unsplash.com/photo-1603584173870-7f3118941648?auto=format&fit=crop&q=80&w=1000",
    beforeImage: "https://images.unsplash.com/photo-1507136566006-cfc505b114fc?auto=format&fit=crop&q=80&w=1000",
    tag: "Transformation",
  ...
  },
  {
    ...
    beforeImage: "https://images.unsplash.com/photo-1584622650111-993a426fbf0a?auto=format&fit=crop&q=80&w=1000",
    tag: "Sanitization",
  ...
  },
  {
    ...
    beforeImage: "https://images.unsplash.com/photo-1584622781564-1d987f7333c1?auto=format&fit=crop&q=80&w=1000",
...
export const Hero: React.FC<HeroProps> = ({ onBookNow, onViewServices }) => {
  ...
  React.useEffect(() => {
    const timer = setInterval(nextSlide, 12000); // Slowed down from 8000 to 12000
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <AnimatePresence mode="wait">
            ...
            >
              ...
              <div className="mt-12 flex items-center gap-8 text-[10px] font-bold text-white/40 uppercase tracking-widest">
            ...
            <AnimatePresence mode="wait">
              ...
              >
                <div className="aspect-square rounded-3xl overflow-hidden glass-card p-2 border-white/10 group relative">
                  ...
                  <div className="absolute top-8 right-8 bg-white/5 backdrop-blur-md border border-white/10 px-3 py-1 rounded-full text-[8px] font-bold text-white/40 uppercase tracking-widest group-hover:opacity-0 transition-opacity">
                    After View
                  </div>
                  
                  {/* Floating Stat Card */}
                  <div className="absolute bottom-8 left-8 right-8 glass-card p-8 border-white/20 text-white backdrop-blur-3xl shadow-2xl">
                    <div className="flex justify-between items-end">
                      ...
                      <div className="text-right">
                        <p className="text-white/40 text-[10px] mb-2 uppercase tracking-widest font-bold">Location</p>
