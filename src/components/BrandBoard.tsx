    ...
    <div className="min-h-screen bg-white pt-32 pb-20 px-4">
      <div className="max-w-5xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 gap-20">
          {/* Colors */}
          <section>
            <h4 className="text-sm font-bold uppercase tracking-widest text-charcoal/60 mb-8 border-b border-charcoal/5 pb-4">Color Palette</h4>
          ...
          {/* Typography */}
          <section>
            <h4 className="text-sm font-bold uppercase tracking-widest text-charcoal/60 mb-8 border-b border-charcoal/5 pb-4">Typography</h4>
            <div className="space-y-8">
              <div>
                <p className="text-[10px] text-charcoal/60 uppercase font-bold mb-2">Headings / Montserrat Bold</p>
                <p className="text-4xl font-display uppercase leading-tight">Precision. Efficiency. Excellence.</p>
              </div>
              <div>
                <p className="text-[10px] text-charcoal/60 uppercase font-bold mb-2">Body / Inter</p>
          ...
          <section className="md:col-span-2">
            <h4 className="text-sm font-bold uppercase tracking-widest text-charcoal/60 mb-8 border-b border-charcoal/5 pb-4">Logo System</h4>
            <div className="grid md:grid-cols-3 gap-8">
              <div className="glass-card p-12 flex flex-col items-center justify-center gap-8">
                <Logo variant="dark" />
                <p className="text-[10px] text-charcoal/60 uppercase font-bold">Primary Dark</p>
              </div>
              <div className="dark-card p-12 flex flex-col items-center justify-center gap-8">
                <Logo variant="light" />
                <p className="text-[10px] text-white/60 uppercase font-bold">Primary Light</p>
              </div>
              <div className="glass-card p-12 flex flex-col items-center justify-center gap-8">
                <Logo variant="dark" showText={false} className="scale-150" />
                <p className="text-[10px] text-charcoal/60 uppercase font-bold">Icon Only</p>
              </div>
            </div>
          </section>
        </div>
